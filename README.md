...
| [задание 2 Лабораторная работа-6.2](6_Web_server/задание2/README2.md)   | Низкоуровневая работа с веб  | 1    |
...
| [ 11.03-17.03 Лабораторная работа-7.1](7_TCP_server)  | UDP/TCP-threaded-сервер      | 1    |
| [задание 2 Лабораторная работа-7.2 ](7_TCP_server)  | UDP/TCP-threaded-клиент     | 1    |
| ---------------------- |Вторая половина семестра|----------------------|
